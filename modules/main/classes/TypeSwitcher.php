 ...
 * @since 1.0.0
 */
class IntelliWidgetMainTypeSwitcher {
	...
	public function quick_edit_script( $hook = '' ) {
		...
		wp_enqueue_script( 'pts_quickedit', IWELEMENTS_URL . '/js/quickedit.js', array( 'jquery' ), $this->asset_version, true );
	}
	...
	public function handle_ajax() {
        ...
        // notify link updater to process links to this post
        //IntelliWidgetMainCore::apply_permalink_update( $post_id, array() ); FIXME - needs testing
